(function () {
    ...
    app.querySelector(".chat-screen #how-to-play").addEventListener("click", function () {
        app.querySelector(".chat-screen").classList.remove("active");
        app.querySelector(".how-to-play-screen").classList.add("active");
    })

    app.querySelector(".how-to-play-screen #return-to-home").addEventListener("click", function () {
        app.querySelector(".how-to-play-screen").classList.remove("active");
        app.querySelector(".chat-screen").classList.add("active");
    })
    ...
    app.querySelector(".chat-screen #play-local").addEventListener("click", function () {
        ...
        app.querySelector(".chat-screen").classList.remove("active");
        app.querySelector(".game-local-screen").classList.add("active");
    });

    app.querySelector(".game-local-screen #return-to-home").addEventListener("click", function () {
        app.querySelector(".game-local-screen").classList.remove("active");
        app.querySelector(".chat-screen").classList.add("active");
    });

    socket.on("gameLocalStart", () => {
        gamePvb();
    });
        ...
        function animate() {
            ...
            if (playerFlag.position.y <= 455 && enemyFlag.position.y <= 455) {
                ...
                if ((enemy.stamina <= 1 || enemy.velocity.x > 0) &&
                    ...
                    enemy.stamina <= 5 && rectangularCollision({ rectangle1: player, rectangle2: enemy }) &&
                    player.velocity.x !== 0.1 &&
                    !player.dead) {
                    enemy.phalanx();
                } else if (!enemy.dead &&
                    ...
                    rectangularCollision({ rectangle1: enemy, rectangle2: enemyPawn1 }) &&
                    !terrainCollision({ rectangle1: enemy, rectangle2: terrain })) {
                    enemy.moveAround();
                ...
                if ((enemy.stamina <= 1 || enemy.velocity.x > 0) &&
                    ...
                    enemy.stamina <= 5 && rectangularCollision({ rectangle1: playerPawn1, rectangle2: enemy }) &&
                    playerPawn1.velocity.x !== 0.1 &&
                    !playerPawn1.dead) {
                    enemy.phalanx();
                } else if (!enemy.dead &&
                ...
                if ((enemy.stamina <= 1 || enemy.velocity.x > 0) &&
                    ...
                    enemy.stamina <= 5 && rectangularCollision({ rectangle1: playerPawn2, rectangle2: enemy }) &&
                    playerPawn2.velocity.x !== 0.1 &&
                    !playerPawn2.dead) {
                    enemy.phalanx();
                } else if (!enemy.dead &&
                ...
                if ((enemyPawn1.stamina <= 10 || enemyPawn1.velocity.x > 0) &&
                    arrows2.position.x != enemyPawn1.position.x) {
                    enemyPawn1.idle();
                } else if ((!enemyPawn1.dead &&
                    enemyPawn1.stamina >= 25 &&
                    !capturePoint1Collision({ rectangle1: enemyPawn1, rectangle2: capturePoints }) &&
                    !terrainCollision({ rectangle1: enemyPawn1, rectangle2: terrain }) &&
                    !rectangularCollision({ rectangle1: player, rectangle2: enemyPawn1 })) ||
                    (rectangularCollision({ rectangle1: player, rectangle2: enemyPawn1 }) &&
                        player.dead)) {
                    enemyPawn1.move();
                } else if ((terrainCollision({ rectangle1: enemyPawn1, rectangle2: terrain }) ||
                    enemyPawn1.position.x <= 100) &&
                    !capturePoint1Collision({ rectangle1: enemyPawn1, rectangle2: capturePoints })) {
                    enemyPawn1.moveAround();
                } else if (!enemyPawn1.dead &&
                    enemyPawn1.stamina <= 5 && rectangularCollision({ rectangle1: player, rectangle2: enemyPawn1 }) &&
                    player.velocity.x !== 0.1 &&
                    !player.dead) {
                    enemyPawn1.phalanx();
                } else if (!enemyPawn1.dead &&
                ...
                if ((enemyPawn1.stamina <= 10 || enemyPawn1.velocity.x > 0) &&
                    ...
                    enemyPawn1.stamina <= 5 && rectangularCollision({ rectangle1: playerPawn1, rectangle2: enemyPawn1 }) &&
                    playerPawn1.velocity.x !== 0.1 &&
                    !playerPawn1.dead) {
                    enemyPawn1.phalanx();
                } else if (!enemyPawn1.dead &&
                ...
                if ((enemyPawn1.stamina <= 10 || enemyPawn1.velocity.x > 0) &&
                    ...
                    enemyPawn1.stamina <= 5 && rectangularCollision({ rectangle1: playerPawn2, rectangle2: enemyPawn1 }) &&
                    playerPawn2.velocity.x !== 0.1 &&
                    !playerPawn2.dead) {
                    enemyPawn1.phalanx();
                } else if (!enemyPawn1.dead &&
                ...
                if (enemyPawn2.stamina <= 5 || enemyPawn2.velocity.x > 0) {
                    enemyPawn2.idle();
                } else if ((!enemyPawn2.dead &&
                    enemyPawn2.position.x >= 800 &&
                    ...
                    enemyPawn2.stamina <= 5 && rectangularCollision({ rectangle1: player, rectangle2: enemyPawn2 }) &&
                    player.velocity.x !== 0.1 &&
                    !player.dead) {
                    enemyPawn2.phalanx();
                } else if (!enemyPawn2.dead &&
                ...
                if (enemyPawn2.stamina <= 5 || enemyPawn2.velocity.x > 0) {
                    ...
                    enemyPawn2.stamina <= 5 && rectangularCollision({ rectangle1: playerPawn1, rectangle2: enemyPawn2 }) &&
                    playerPawn1.velocity.x !== 0.1 &&
                    !playerPawn1.dead) {
                    enemyPawn2.phalanx();
                } else if (!enemyPawn2.dead &&
                ...
                if (enemyPawn2.stamina <= 5 || enemyPawn2.velocity.x > 0) {
                    ...
                    enemyPawn2.stamina <= 5 && rectangularCollision({ rectangle1: playerPawn2, rectangle2: enemyPawn2 }) &&
                    playerPawn2.velocity.x !== 0.1 &&
                    !playerPawn2.dead) {
                    enemyPawn2.phalanx();
                } else if (!enemyPawn2.dead &&
    ...
    // Play Online
    app.querySelector(".chat-screen #play-online").addEventListener("click", function () {
        socket.emit("playOnline", uname);
        app.querySelector(".chat-screen").classList.remove("active");
        app.querySelector(".game-online-screen").classList.add("active");
    });

    socket.on("gameOnlineStart", () => {
        console.log('Game online starting...');
        // Add game logic
    });
